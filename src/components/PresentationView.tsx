...
import { generatePresentationWithGemini } from '../services/ai';
...
export const PresentationView: React.FC = () => {
  ...
  const handleGeneratePresentation = async () => {
    ...
    setIsLoading(true);
    try {
      const data = await generatePresentationWithGemini(topic, slideCount, selectedTheme, tone);
      ...
      console.error('[Farhee Presentation Error]:', err);
    } finally {
      setIsLoading(false);
    }
  };
